...
public class AiFunctionFunctionTest {

    @Test
    public void testGet() throws Exception {
        try (HttpFunction function = new HttpFunction()) {
            GoogleHttpResponse response = function.invoke(HttpMethod.GET, "/aiFunction");
    ...
    public void testPost()throws  Exception{
        try (HttpFunction function = new HttpFunction()) {
            ...
            HttpRequest request = HttpRequest.POST("/aiFunction", sampleInputMessage).contentType(MediaType.APPLICATION_JSON_TYPE);
